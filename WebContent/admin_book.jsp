...
<div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        %>
                        <tbody>
                        <td id="card"><%= bean.getCard() %>
                        </td>
                        <td id="type"><%= bean.getType() %>
                        </td>
                        <td id="bname"><%= bean.getName() %>
                        </td>
                        <td id="autho"><%= bean.getAutho() %>
                        </td>
                        <td id="press"><%= bean.getPress() %>
                        </td>
                        <td id="num"><%= bean.getNum() %>
                        </td>
                        <td>
    ...
    <script type="text/javascript">
        ...
        /* $("#btn_update").on(click,function showInfo1(x) {
             document.getElementById("updateISBN").value = x;
             document.getElementById("updateBookName").value = 2;
             document.getElementById("updateAutho").value = 3;
             document.getElementById("updatePress").value = 4;
             document.getElementById("updateBookType").value = 5;
             document.getElementById("updateNum").value = 6;
             document.getElementById("updateBookId").value = 7;
         });*/

        /* function showInfo1(x) {
             document.getElementById("updateISBN").value = x;
         }*/
        ...
        function deletebook(bid) {
            con = confirm("是否删除?");
            if (con == true) {
                location.href = "${pageContext.request.contextPath}/deleteServlet?bid=" + bid;
            }
        }
    </script>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <input type="text" class="form-control" id="updateISBN" name="card"
                                       placeholder="请输入书号">
