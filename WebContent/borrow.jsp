        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/books/index2.jsp"><strong>欢迎使用图书馆管理系统</strong></a>
        ...
        <div class="col-md-10">
            ...
            <script type="text/javascript">
                function haibook(hid) {
                    con = confirm("是否还书?");
                    if (con == true) {
                        location.href = "${pageContext.request.contextPath}/borrowServlet?tip=2&show=1&hid=" + hid;
                    }
                }
            </script>
        </div>
